package org.atos.scouter.KeaTopicExtraction.filters;
...
import org.atos.scouter.KeaTopicExtraction.vocab.Vocabulary;
...
public class KEAFilter extends Filter implements OptionHandler {
	...
	private org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords m_Stopwords = new StopwordsSpanish();
	 ...
	 */
	public void setStopwords(org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords newM_Stopwords) {
	...
	public void loadThesaurus(Stemmer st, org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords sw) {
