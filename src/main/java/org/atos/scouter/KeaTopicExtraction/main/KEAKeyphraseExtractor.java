package org.atos.scouter.KeaTopicExtraction.main;
...
import org.atos.scouter.KeaTopicExtraction.filters.KEAFilter;
import org.atos.scouter.KeaTopicExtraction.filters.KEAPhraseFilter;
import org.atos.scouter.KeaTopicExtraction.stemmers.SremovalStemmer;
import org.atos.scouter.KeaTopicExtraction.stemmers.Stemmer;
import org.atos.scouter.KeaTopicExtraction.stopwords.StopwordsEnglish;
import org.atos.scouter.KeaTopicExtraction.util.Counter;
import weka.core.*;
...
public class KEAKeyphraseExtractor implements OptionHandler {
	...
	private org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords m_Stopwords = new StopwordsEnglish();
	 ...
	 */
	public org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords getStopwords() {
	 ...
	 */
	public void setStopwords(org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords newStopwords) {
	...
	public void setOptions(String[] options) throws Exception {
		...
		if (stopwordsString.length() > 0) {
			...
			setStopwords((org.atos.scouter.KeaTopicExtraction.stopwords.Stopwords)Class.forName(stopwordsString).newInstance());
		}
	...
	public ArrayList<String> extractKeyphrasesFromText(String input) throws Exception {
        ...
        newInst[0] = (double)data.attribute(0).addStringValue(input.toString());
        ...
        for (int i = 0; i < m_numPhrases; i++) {
            if (topRankedInstances[i] != null) {
                ...
                output.add(topRankedInstances[i].
                        stringValue(m_KEAFilter.getUnstemmedPhraseIndex()));
